...
patientDeferred  = Q.defer();
conceptDeferred = Q.defer();
visitDeferred = Q.defer();
providerDeferred = Q.defer();
codelookupDeferred = Q.defer();
obsFactDeferred = Q.defer();

getPatients = wrapFunction(copyTable, this, [patientDeferred, 0, 2048, patient_dimension_kumc, patient_dimension_nemo,'patient_num']);
getConcepts = wrapFunction(copyTable, this, [conceptDeferred, 0, 2048, concept_dimension_kumc, concept_dimension_nemo,'concept_path']);
getVisits = wrapFunction(copyTable, this, [visitDeferred, 0, 2048, visit_dimension_kumc, visit_dimension_nemo,'encounter_num']);
getProviders = wrapFunction(copyTable, this, [providerDeferred, 0, 2048, provider_dimension_kumc, provider_dimension_nemo,'provider_id']);
getCodeLookup = wrapFunction(copyTable, this, [codelookupDeferred, 0, 2048, code_lookup_kumc, code_lookup_nemo,'table_cd']);
getObservationFact = wrapFunction(copyTable, this, [obsFactDeferred, 0, 2048, observation_fact_kumc, observation_fact_nemo,'encounter_num']);
