(function (root, factory) {
    ...
    // pages/globalDashboard.jade compiled template
    templatizer["pages"]["globalDashboard"] = function tmpl_pages_globalDashboard(locals) {
        var buf = [];
        var jade_mixins = {};
        var jade_interp;
        return buf.join("");
    ...
    templatizer["pages"]["settings"] = function tmpl_pages_settings(locals) {
        var buf = [];
        var jade_mixins = {};
        var jade_interp;
        return buf.join("");
    ...
    // pages/userDashboard.jade compiled template
    templatizer["pages"]["userDashboard"] = function tmpl_pages_userDashboard(locals) {
        var buf = [];
        var jade_mixins = {};
        var jade_interp;
        return buf.join("");
